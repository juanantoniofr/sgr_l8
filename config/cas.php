...
return [
    ...
    */
    ...
    'cas_hostname'        => env('CAS_HOSTNAME', 'ssopre.us.es'),
    ...
    */
    ...
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'ssopre.us.es'),
    ...
    */
    ...
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'https://ssopre.us.es/CAS/logout'),
    ...
    */
    ...
    'cas_logout_redirect' => env('CAS_LOGOUT_REDIRECT', 'https://150.214.135.226:4445/sgr'),
    ...
    */
    ...
    'cas_redirect_path'   => env('CAS_REDIRECT_PATH', 'https://150.214.135.226:4445/sgr/user/profile'),
